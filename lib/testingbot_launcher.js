...
function processConfig (helper, config, args) {
  ...
  var apiKey = args.apiKey || config.apiKey || process.env.TB_KEY
  var apiSecret = args.apiSecret || config.apiSecret || process.env.TB_SECRET
...
var TBLauncher = function (
  ...
  var driver = wd.promiseChainRemote('hub.testingbot.com', 80, apiKey, apiSecret)
