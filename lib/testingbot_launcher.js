...
function processConfig (helper, config, args) {
  ...
  var apiKey = args.apiKey || config.apiKey || process.env.TESTINGBOT_KEY
  var apiSecret = args.apiSecret || config.apiSecret || process.env.TESTINGBOT_SECRET
...
var TBLauncher = function (
  ...
  var driver = wd.promiseChainRemote('127.0.0.1', connectOptions['se-port'], apiKey, apiSecret)
